    ...
    <div className="space-y-10">
      ...
      <section className="rounded-[2rem] border border-rose-100 bg-gradient-to-r from-rose-50 to-amber-50 p-6 sm:p-8">
        ...
        <ul className="mt-4 space-y-2 text-sm leading-6 text-stone-700">
          <li>
            • Early morning, travel, and add-on hair styling can be quoted
            separately.
          </li>
          <li>
            • Bridal trials are available on request for a more personalized
            final look.
          </li>
          <li>
            • Group and destination wedding packages can be customized after
            consultation.
          </li>
        </ul>
      </section>
